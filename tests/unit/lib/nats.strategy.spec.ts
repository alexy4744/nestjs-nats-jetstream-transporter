...
import { NatsContext, NatsTransportStrategy, NACK, TERM } from "../../../src";

import { NatsStreamConfig } from "../../../src/lib/interfaces/nats-stream-config.interface";
...
describe("NatsTransportStrategy", () => {
  ...
  describe("handleNatsMessage", () => {
    ...
    it("responds to messages", async (complete) => {
